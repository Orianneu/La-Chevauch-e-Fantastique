...
public class FenetreVictoire extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Continuer, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 310, -1, -1));
        ...
        getContentPane().add(Quitter, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 310, 80, -1));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Vous avez réussi ce niveau !");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 210, 520, 80));

        noir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lachevaucheefantastique/noir.jpg"))); // NOI18N
        noir.setText("jLabel1");
        getContentPane().add(noir, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, 420, 190));

        image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lachevaucheefantastique/Image.jpg"))); // NOI18N
        getContentPane().add(image, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -190, 690, 860));
    ...
    private void ContinuerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ContinuerActionPerformed
        ...
        SwingUtilities.invokeLater(() -> new Niveau2graph());
