 ...
 * @author leafr
 */
public class FenetreVictoire5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Bonus, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 310, 80, -1));
        ...
        getContentPane().add(Quitter, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 310, 80, -1));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Vous avez réussi tous les niveaux !");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 220, 520, 80));

        noir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lachevaucheefantastique/noir.jpg"))); // NOI18N
        noir.setText("jLabel1");
        getContentPane().add(noir, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, 420, 190));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FenetreVictoire5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
