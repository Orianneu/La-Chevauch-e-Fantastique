 ...
 * @author leafr
 */
public class FenetreVictoireLibre extends javax.swing.JFrame {

    /**
     * Creates new form FenetreVictoire
     */
    public FenetreVictoireLibre() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vous avez réussi tous le niveau Libre !");
        ...
        getContentPane().add(noir, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 160, 440, 190));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FenetreVictoireLibre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
